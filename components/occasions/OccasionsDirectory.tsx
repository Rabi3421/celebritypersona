...
import type { Occasion, OccasionGroup } from "@/lib/types";
...
function GroupSection({occasions,group,eyebrow,title,body,section=false}:{occasions:Occasion[];group:OccasionGroup;eyebrow:string;title:string;body:string;section?:boolean}){
