...
export const metadata: Metadata = pageMetadata({
  title: "Report a Wrong Price or Dead Link",
  description: "Spotted a price that has changed or a link that has died? Report it here and we will check it against the retailer, usually the same day.",
  path: "/report-a-price",
});
